  ...
  <div class="wrapper">
    <Form :validation-schema="productform" @submit="submitproduct">
      <div class="form-group">
        ...
        <Field type="text" class="form-control" id="nameproduct" name="name" placeholder="Enter name product"
      ...
      <div class="form-group">
        ...
        <div style="display: flex; flex-direction: row;">
          <Field type="text" class="form-control" id="imgproduct" name="img" placeholder="Enter link product image"
            v-model="productLocal.img[0]" />
          <i class="bi bi-file-plus btn_img-add" @click="addImge()"></i>
        </div>
        <input type="text" class="form-control" id="imgproduct2" placeholder="Enter link product image" name="img"
      ...
      <div class="form-group">
        ...
        <Field type="number" class="form-control" id="priceproduct" name="price" placeholder="Enter product price"
      ...
      <div class="form-group">
        ...
        <Field type="text" class="form-control" id="nameproduct" name="description"
          placeholder="Enter product description" v-model="productLocal.desc" />
        <ErrorMessage name="description" class="text-danger" />
      </div>
      <br>
      <div class="form-group">
        <label for="categoryproduct">Phân loại</label>
        <Field type="text" class="form-control" id="categoryproduct" name="category" placeholder="Enter product categrogy"
      ...
      <button type="submit" class="btn btn-dark m-5">Lưu</button>
