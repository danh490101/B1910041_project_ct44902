  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-white">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <img src="../assets/img/logo.jpg" alt="" style="width: 66px;">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown text-dark">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="#od">OWNSDAY</a></li>
              <li><a class="dropdown-item" href="#gm">GENTLEMONSTER</a></li>
            </ul>
          </li>
        ...
        <div class="Cart">
          <div class="wrapper_cart">
            ...
            <i class="bi bi-cart3 icon icon_cart"></i>
            <span class="quantity_cart">{{ getlengthcarts }}</span>   </router-link>
          </div>
        ...
        <div class="User">
          <div class="not-login">
            <i class="bi bi-person-circle icon text-dark mr-5" data-bs-toggle="collapse" href="#user"></i>
          ...
          <div class="login">
            <span class="text-light data_user text-dark mr-5" data-bs-toggle="collapse" href="#user"></span>
            <div class="collapse user_link" id="user">
              <div class="card card-body bg-white connect-shop">
